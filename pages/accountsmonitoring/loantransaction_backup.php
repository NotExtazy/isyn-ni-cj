                                ...
                                <div class="row mt-4">
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="add_product" id="add_product" class="form-select border-secondary border-opacity-50" aria-label="Default select example" onchange="computePrincipal()">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="add_amount" id="add_amount" value="" type="text" class="form-control border-secondary border-opacity-50" oninput="computeAmortization(); computeAddInterest(); computeAddPrincipal(this.value); validateNumber(this);">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="add_downpaymentAmount" id="add_downpaymentAmount" type="text" class="form-control border-secondary border-opacity-50" disabled oninput="computeDownPayment(); validateNumber(this);">
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="add_sector" class="form-select border-secondary border-opacity-50" aria-label="Default select example">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input name="add_firstName" type="text" class="form-control border-secondary border-opacity-50" id="formGroupExampleInput" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            <label for="formGroupExampleInput" class="form-label mb-0">Middle Name</label>
                                                            <input name="add_middleName" type="text" class="form-control border-secondary border-opacity-50" id="formGroupExampleInput" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            <label for="formGroupExampleInput" class="form-label mb-0">Last Name</label>
                                                            <input name="add_lastName" type="text" class="form-control border-secondary border-opacity-50" id="formGroupExampleInput" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="shadow rounded-3 p-3 bg-white">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput" class="form-label mb-0">First Name</label>
                                            <input type="text" name="firstname" class="form-control border-secondary border-opacity-50" id="formGroupExampleInput" placeholder="" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput" class="form-label mb-0">Middle Name</label>
                                            <input type="text" name="middlename" class="form-control border-secondary border-opacity-50" id="formGroupExampleInput" placeholder="" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput" class="form-label mb-0">Last Name</label>
                                            <input type="text" name="lastname" class="form-control border-secondary border-opacity-50" id="formGroupExampleInput" placeholder="" disabled>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <h6 class="mb-3" id="errorMessage">An error occurred!</h6>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <h6 class="mb-3" id="warningMessage">Please check your input!</h6>
...
?>
            // Clear renewal utilization table button
            $('#clearRenewalUtilizationBtn').on('click', function() {
                // Keep first row but clear its values and disable inputs
                $('#renewalUtilizationTableBody tr').slice(1).remove();
                $('#renewalUtilizationTableBody tr:first select, #renewalUtilizationTableBody tr:first input').val('').prop('disabled', true);
                updateRenewalUtilizationTotals();
            ...
            function updateRenewalUtilizationTotals() {
                ...
                // Get loan amount and calculate difference
                var loanAmount = parseFloat($('#renewalUtilizationLoanAmount').val()) || 0;
                var difference = loanAmount - total;
                $('#renewalUtilizationDifference').val(difference.toFixed(2));
                
                // Update difference color based on value
                if (difference === 0) {
                    $('#renewalUtilizationDifference').removeClass('text-danger text-warning').addClass('text-success');
