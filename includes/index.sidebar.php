<?php
    ...
    try {
        ...
        // Fallback - create a dummy permissions object
    ...
    // Detect base path for links when app is in a subdirectory (e.g., /iSynApp-main)
...
<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="/dashboard" class="navbar-brand">
                <!--Logo start-->
                <div class="logo-main">
                    <img src="assets/images/small-logo.png" alt="isynergies logo" style="width: 30px; height: auto;">
                </div>
                <!--logo End-->
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse <?= ($_SESSION['parent_module'] === 'Profiling') ? 'show' : '' ?>" id="profiling-panel" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Customerinfo') ? 'active' : '' ?>" href="/profiling/customerinfo">
                                  <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Supplierinfo') ? 'active' : '' ?>" href="/profiling/supplierinfo">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Isynstaff') ? 'active' : '' ?>" href="/profiling/isynstaff">
                                   <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Shareholderinfo') ? 'active' : '' ?>" href="/profiling/shareholderinfo">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Boardofdirectors') ? 'active' : '' ?>" href="/profiling/boardofdirectors">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Acashinfo') ? 'active' : '' ?>" href="/profiling/acashinfo">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse <?= ($_SESSION['parent_module'] === 'Cashier') ? 'show' : '' ?>" id="cashier-panel" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Loanspayment') ? 'active' : '' ?>" href="<?php echo $base; ?>/pages/cashier/loanspayment.php">
                                  <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Otherpayment') ? 'active' : '' ?>" href="/cashier/otherpayment">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Depositslip') ? 'active' : '' ?>" href="/cashier/depositslip">
                                   <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Collectionreport') ? 'active' : '' ?>" href="/cashier/collectionreport">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Tellersproofsheet') ? 'active' : '' ?>" href="/cashier/tellersproofsheet">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Deletecancel') ? 'active' : '' ?>" href="<?php echo $base; ?>/deletecancel">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $cashierconfiguration) ? 'show' : '' ?>" id="cashier-configuration-panel" data-bs-parent="#cashier-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Orsettings') ? 'active' : '' ?>" href="/cashier/orsettings">
                                          <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Dssettings') ? 'active' : '' ?>" href="/cashier/dssettings">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <ul class="sub-nav collapse <?= ($_SESSION['parent_module'] === 'Accountsmonitoring') ? 'show' : '' ?>" id="accounts-monitoring-panel" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $othertransaction) ? 'show' : '' ?>" id="am-other-transaction-panel" data-bs-parent="#accounts-monitoring-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Journalvoucher') ? 'active' : '' ?>" href="/accountsmonitoring/journalvoucher">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Otherdisbursement') ? 'active' : '' ?>" href="/accountsmonitoring/otherdisbursement">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Amortization') ? 'active' : '' ?>" href="/accountsmonitoring/amortization">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Loantransaction') ? 'active' : '' ?>" href="<?php echo $base; ?>/pages/accountsmonitoring/loantransaction.php">
                                   <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Accountsandaging') ? 'active' : '' ?>" href="/accountsmonitoring/accountsandaging">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $amconfiguration) ? 'show' : '' ?>" id="am-configuration-panel" data-bs-parent="#accounts-monitoring-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Chartofaccounts') ? 'active' : '' ?>" href="/accountsmonitoring/chartofaccounts">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Banks') ? 'active' : '' ?>" href="/accountsmonitoring/banks">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Fundings') ? 'active' : '' ?>" href="/accountsmonitoring/fundings">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $amreport) ? 'show' : '' ?>" id="am-reports-panel" data-bs-parent="#accounts-monitoring-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Bookofaccounts') ? 'active' : '' ?>" href="/accountsmonitoring/bookofaccounts">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse <?= ($_SESSION['parent_module'] === 'Generalledger') ? 'show' : '' ?>" id="general-ledger-panel" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($_SESSION['current_module'] === 'Postandundopost') ? 'active' : '' ?>" href="/generalledger/postandundopost">
                                  <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $ledgers) ? 'show' : '' ?>" id="gl-ledgers-panel" data-bs-parent="#general-ledger-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Snapshot') ? 'active' : '' ?>" href="/generalledger/snapshot">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Generalledger') ? 'active' : '' ?>" href="/generalledger/generalledger">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Subsidiaryledger') ? 'active' : '' ?>" href="/generalledger/subsidiaryledger">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $financials) ? 'show' : '' ?>" id="gl-financials-panel" data-bs-parent="#general-ledger-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Financialstatement') ? 'active' : '' ?>" href="/generalledger/financialstatement">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $GLutilities) ? 'show' : '' ?>" id="gl-utilities-panel" data-bs-parent="#general-ledger-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Fundconfiguration') ? 'active' : '' ?>" href="/generalledger/fundconfiguration">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Dataconfiguration') ? 'active' : '' ?>" href="/generalledger/dataconfiguration">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Updatetablestructure') ? 'active' : '' ?>" href="/generalledger/updatetablestructure">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <ul class="sub-nav collapse <?= ($_SESSION['parent_module'] === 'Inventorymanagement') ? 'show' : '' ?>" id="inventory-management-panel" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $inventory) ? 'show' : '' ?>" id="im-inventory-panel" data-bs-parent="#inventory-management-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Incominginventory') ? 'active' : '' ?>" href="<?php echo $BASE_PATH; ?>/pages/inventorymanagement/incominginventory.php">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Outgoinginventory') ? 'active' : '' ?>" href="<?php echo $BASE_PATH; ?>/pages/inventorymanagement/outgoinginventory.php">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Transmittalreceipt') ? 'active' : '' ?>" href="/inventorymanagement/transmittalreceipt">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Consignment') ? 'active' : '' ?>" href="/inventorymanagement/consignment">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Purchasedreturn') ? 'active' : '' ?>" href="/inventorymanagement/purchasedreturn">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Orderconfirmation') ? 'active' : '' ?>" href="/inventorymanagement/orderconfirmation">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $search) ? 'show' : '' ?>" id="im-search-panel" data-bs-parent="#inventory-management-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Searchproducts') ? 'active' : '' ?>" href="/inventorymanagement/searchproducts">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Inventory') ? 'active' : '' ?>" href="/inventorymanagement/inventory">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Inventorybalancing') ? 'active' : '' ?>" href="/inventorymanagement/inventorybalancing">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Purchaseandsales') ? 'active' : '' ?>" href="/inventorymanagement/purchaseandsales">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Paidunpaiditems') ? 'active' : '' ?>" href="/inventorymanagement/paidunpaiditems">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Purchasedreturnreport') ? 'active' : '' ?>" href="/inventorymanagement/purchasedreturnreport">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $edittransaction) ? 'show' : '' ?>" id="im-edit-transaction-panel" data-bs-parent="#inventory-management-panel">
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Cancelanddeletesi') ? 'active' : '' ?>" href="/inventorymanagement/cancelanddeleteSI">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Cancelconsignment') ? 'active' : '' ?>" href="/inventorymanagement/cancelconsignment">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $configuration) ? 'show' : '' ?>" id="im-configuration-panel" data-bs-parent="#inventory-management-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Productmaintenance') ? 'active' : '' ?>" href="/inventorymanagement/productmaintenance">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Sisetup') ? 'active' : '' ?>" href="/inventorymanagement/sisetup">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Changeproductsrpdp') ? 'active' : '' ?>" href="/inventorymanagement/changeproductsrpdp">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse <?= in_array($_SESSION['current_module'], $utilities) ? 'show' : '' ?>" id="im-utilities-panel" data-bs-parent="#inventory-management-panel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Closetransaction') ? 'active' : '' ?>" href="/inventorymanagement/closetransaction">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($_SESSION['current_module'] === 'Backup') ? 'active' : '' ?>" href="/inventorymanagement/backup">
                                            <i class="icon">
                                                <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                    <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li><hr class="hr-horizontal"></li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#administrator-panel" role="button" aria-expanded="false" aria-controls="sidebar-administrator">
                        ...
                        <ul class="sub-nav collapse" id="administrator-panel" data-bs-parent="#sidebar-menu">
