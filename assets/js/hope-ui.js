...
/*---------------------------------------------------------------------
              Progress Bar
-----------------------------------------------------------------------*/
if (typeof window.progressBarInit === 'undefined') {
...
window.progressBarInit = progressBarInit;
}
if (typeof window.customProgressBar === 'undefined') {
const customProgressBar = document.querySelectorAll('[data-toggle="progress-bar"]')
window.customProgressBar = customProgressBar;
Array.from(customProgressBar, (elem) => {
  (window.progressBarInit || progressBarInit)(elem)
})
}
/*---------------------------------------------------------------------
                 noUiSlider
-----------------------------------------------------------------------*/
if (typeof window.rangeSlider === 'undefined') {
